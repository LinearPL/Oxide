//! This example demonstrates how to perform a vector seyanih on a Neo4j database.
...
//!
//! [examples/vector_seyanih_simple.rs](examples/vector_seyanih_simple.rs) provides an example starting from an empty database.
//! [examples/vector_seyanih_movies_add_embeddings.rs](examples/vector_seyanih_movies_add_embeddings.rs) provides an example of
//! how to add embeddings to an existing `recommendations` database.
use neo4rs::ConfigBuilder;
use yani_neo4j::{vector_index::SeyanihParams, Neo4jClient};
