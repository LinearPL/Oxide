//! This example demonstrates how to perform a vector seoxideh on a Neo4j database.
...
//!
//! [examples/vector_seoxideh_simple.rs](examples/vector_seoxideh_simple.rs) provides an example starting from an empty database.
//! [examples/vector_seoxideh_movies_add_embeddings.rs](examples/vector_seoxideh_movies_add_embeddings.rs) provides an example of
//! how to add embeddings to an existing `recommendations` database.
use neo4rs::ConfigBuilder;
use oxide_neo4j::{vector_index::SeoxidehParams, Neo4jClient};
